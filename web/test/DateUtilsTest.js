...
define([mutName], function(mut) {
  describe(mutName + '.formatTimestamp', function() {
    ...
    it('should formats the timestamp value representing "2000-01-01T13:00:00.000(UTC)" ' +
        'to datetime string format', function() {
    ...
    it('should formats the ISO String "2000-01-01T13:00:00.000(UTC)" ' +
        'to datetime string format in UTC timezone', function() {
  ...
  describe(mutName + '.formatLocalDate', function() {
    ...
    it('should formats the ISO string "2000-06-01T13:00:00.000(UTC)" ' +
        'to datetime string toISOString local date format', function() {
    ...
    it('should formats the timestamp value representing "2000-06-01T13:00:00.000(UTC)" ' +
        'to datetime string toISOString local date format', function() {
